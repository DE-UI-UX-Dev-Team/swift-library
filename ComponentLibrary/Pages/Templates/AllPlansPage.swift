...
//                                             Tag(text: "100% Solar", style: .active(.yellowBase)),
            ...
            PlanCard(
                ...
                priceRate: PriceRate(price: "17.6", unit: "/kWh"),
                priceDescription: "price at 1800 kWh",
                tags: [
                    Tag(text: "12 months", style: .inactive),
                    Tag(text: "Fixed rate", style: .inactive),
        ...
        ZStack(alignment: .bottom) {
            ScrollView {
                VStack(alignment: .leading, spacing: brandSpacing.pageLayout.sectionSpacing.l) {
                    ...
                    Spacer(minLength: selectedPlanID != nil ? 100 : 0)
                }
            }
...
struct BottomStickyView: View, BrandStyleSupport {
    @Environment(\.brand) var brand
    @Environment(\.colorScheme) var colorScheme
    let title: String
